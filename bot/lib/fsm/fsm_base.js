...
class FsmBase {
	...
	add_props(props) {
		...
		props.transitions = props.transitions ? props.transitions.concat(base_transitions) : base_transitions;
			...
			transitions: [{ name: 'goto_error',
				...
				to: function (...error) {
					...
					if (this.error_counter < this.max_errors) {
						...
						//come back to state I'm comming
